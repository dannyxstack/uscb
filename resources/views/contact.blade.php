      ...
      <div class="row">
        <div class="col-md-5" style="padding-top: 100px;">
          ...
          <div class="fs-4">
            ...
            <p>At Unity Skills College of Hospitality, we understand that choosing the right educational institution is one of the most significant decisions you'll make. That's why we're committed to providing personalized guidance every step of the way. Ready to start your next project with us? Send us a message and we will get back to you as soon as possible!</p>
