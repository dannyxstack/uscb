  ...
  <footer class="footer section-bg-footer">
      ...
      <div class="row footer-nav-row mt-3">
        ...
        <div class="col-md-4">
          ...
          <ul class="list-unstyled">
            ...
            <li class="mb-2"><a href="/promotion">Promotional Prices</a></li>
        ...
        <div class="col-md-4">
          ...
          <p><i class="fas fa-envelope me-2"></i> info@uscohospitality.edu.au</p>
    ...
    <div class="copyright-row text-center py-5">
      <p class="mb-0">&copy; {{ date('Y') }} Unity Skills College of Hospitality. All rights reserved.</p>
    </div>
  </footer>
