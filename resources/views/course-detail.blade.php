...
.course-right-card {
  ...
  padding: 20px;
  /* 右侧悬挂#C0A96A 60% */
  background-color: rgba(192,169,106, 0.6);
}
...
.course-title {
  ...
  background-color: rgba(192,169,106, 0.6); /* ##CF8CBD 半透明0.7 */
  color: #ffffff;
  /* opacity: 0.7; */
  /* display: flex; */
        ...
        <div class="row">
          <div class="col-md-9">
            <div class="course-title text-start px-4 py-4 ">
              ...
              <p>
                <div class="color-darkblack fs-4 fw-bolder" >CRICOS CODE: {{ $course->cricos_code ?? '' }}</div>
              </p>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 ps-0">
                    ...
                    <div class="bg-lightblue p-4 color-white course-rpl-box">
                      ...
                      <p class="fs-4">Unity Skills College of Hospitality will offer Recognition of Prior Learning (RPL)
                        and Credit Transfer (CT) to all prospective students 
                        through the enrolment process. Unity Skills College of Hospitality has 
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="fs-5">
                      ...
                      <p>Unity Skills College of Hospitality will also monitor overseas student attendance (but would not report, unless otherwise required) in the process of course progress monitoring and reporting. However overseas students must meet their visa obligations regarding attendance, wherever applicable.</p>
            ...
            <div class="row my-4">
              ...
              <div class="col-md-3">
                <div class="card course-pathway-card ps-1 py-2">
                  <div class="card-body">
                    <h5 class="card-title fs-4 color-lightgold course-pathway-card-code">{{ $courseItem['code'] }}</h5>
