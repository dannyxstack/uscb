  ...
  <section class="hero text-center section-bg-banner2">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-7">
          <img src="/images/Student-service.png" alt="Courses Banner" class="img-fluid rounded-5">
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="container">
        <div class="row text-center" style="padding-top: 80px;">
          ...
          <div class="col-md-10 text-start fs-4">
            ...
            <p>Student Services Officers are the first point of contact for students via email (info@unityskills.com.au).</p>
