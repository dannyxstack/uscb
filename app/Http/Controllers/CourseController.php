...
class CourseController extends Controller {
    ...
    public function index() {
        ...
        $keywords = 'Unity Skills College of Hospitality courses, vocational education, hospitality courses, business courses, industry-relevant courses, career success, skills and knowledge, Australia education';
    ...
    public function colleges() {
        ...
        $title = 'Our Colleges';
        $menu1 = 'colleges';
        $description = 'Discover our diverse range of colleges at Unity Skills College of Hospitality, each offering specialized courses designed to equip you with the skills and knowledge needed for success in your chosen career. Explore our hospitality, business, and other industry-relevant colleges to find the perfect fit for your vocational education journey in Australia.';
        $keywords = 'Unity Skills College of Hospitality colleges, vocational education, hospitality college, business college, industry-relevant colleges, career success, skills and knowledge, Australia education';
    ...
    public function detail($code) {
        ...
        $menu1 = 'all-courses';
        $description = 'Discover the details of ' . $course->name . ' at Unity Skills College of Hospitality. This course offers comprehensive training in ' . $course->college . ', designed to equip you with the skills and knowledge needed for success in your chosen career. Explore the course structure, fees, entry requirements, and more to make an informed decision about your vocational education journey in Australia.';
        $keywords = 'Unity Skills College of Hospitality ' . $course->name . ', ' . $course->college . ' course, vocational education, course structure, course fees, entry requirements, career success, skills and knowledge, Australia education';
